...
#' @param z the spatial or tempral points which is required to be the same cross differnt group and replicates.
#' @param g the variable representing the group information.
#'
...
#'
#' @reference 
#'    @bibliography sstest.bib
#'    @cite
#' @export



sstest=function(y=y, z=z, g=g){
